...
@DisplayName("/board/posts/{id}/comments")
public class _board_posts_$id_comments {
    ...
    void given_request_then_response200() throws Exception {
        ...
        // when
        MockHttpServletResponse response = mockMvc.perform(MockMvcRequestBuilders.get("/board/posts/1/comments"))
