...
@DisplayName("/board/comments/{id}/hate")
public class _board_comments_$id_hate {
    ...
    void given_postRequest_then_response201() throws Exception {
        ...
        // when
        MockHttpServletResponse response = mockMvc.perform(MockMvcRequestBuilders.post("/board/comments/1/hate"))
    ...
    void given_delRequest_then_response204() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/board/comments/1/hate"));


        // when
        MockHttpServletResponse response = mockMvc.perform(MockMvcRequestBuilders.delete("/board/comments/1/hate"))
            .andReturn().getResponse();
