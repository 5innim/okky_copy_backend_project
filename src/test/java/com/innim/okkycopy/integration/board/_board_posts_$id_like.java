...
@DisplayName("/board/posts/{id}/like")
public class _board_posts_$id_like {
    ...
    void given_postRequest_then_response201() throws Exception {
        ...
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.post("/board/posts/1/like")
    ...
    void given_delRequest_then_response204() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/board/posts/1/like"));

        // when
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.delete("/board/posts/1/like")
        ).andReturn().getResponse();
