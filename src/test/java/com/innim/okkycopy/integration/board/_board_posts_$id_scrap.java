...
public class _board_posts_$id_scrap {
    ...
    void given_postRequest_then_response201() throws Exception {
        ...
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.post("/board/posts/1/scrap")
    ...
    void given_delRequest_then_response204() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/board/posts/1/scrap"));

        // when
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.delete("/board/posts/1/scrap")
        ).andReturn().getResponse();
