...
@DisplayName("/board/community/posts/{id}")
public class _board_community_posts_$id {
    ...
    void given_invalidTopicWithPutRequest_then_response400() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(
            MockMvcRequestBuilders.put("/board/community/posts/1")
    ...
    void given_getRequest_then_response200() throws Exception {
        ...
        // when
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.get("/board/community/posts/1")
                .characterEncoding("UTF-8")
                .contentType(MediaType.APPLICATION_JSON)
                .content(new Gson().toJson(postRequest))
        ).andReturn().getResponse();
    ...
    void given_delRequest_then_response204() throws Exception {
        ...
        // when
        MockHttpServletResponse response = mockMvc.perform(
            MockMvcRequestBuilders.delete("/board/community/posts/1")
                .characterEncoding("UTF-8")
                .contentType(MediaType.APPLICATION_JSON)
                .content(new Gson().toJson(postRequest))
        ).andReturn().getResponse();
