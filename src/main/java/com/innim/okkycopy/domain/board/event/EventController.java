...
public class EventController {
    ...
    @PostMapping("/write")
    public ResponseEntity<Object> eventPostAdd(@RequestBody @Valid PostRequest postRequest,
    ...
    @PutMapping("/posts/{id}")
    public ResponseEntity<Object> eventPostModify(
        @AuthenticationPrincipal CustomUserDetails customUserDetails,
        @RequestBody @Valid PostRequest updateRequest,
        @PathVariable("id") long id) {
        eventPostService.modifyEventPost(customUserDetails, updateRequest, id);
        return ResponseEntity.status(HttpStatus.NO_CONTENT).build();
    }

    @DeleteMapping("/posts/{id}")
    public ResponseEntity<Object> eventPostRemove(
        @AuthenticationPrincipal CustomUserDetails customUserDetails,
        @PathVariable("id") long id) {
        eventPostService.removeEventPost(customUserDetails, id);
        return ResponseEntity.status(HttpStatus.NO_CONTENT).build();
    }
