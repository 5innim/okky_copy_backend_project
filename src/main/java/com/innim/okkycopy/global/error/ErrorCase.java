...
public enum ErrorCase {
    ...
    _400_ALREADY_EXIST_EXPRESSION(HttpStatus.BAD_REQUEST, "400028", "you've already expressed"),
    _400_BAD_FORM_DATA(HttpStatus.BAD_REQUEST, "400031", "input form data is wrong"),
    _400_NO_CHANGE_PASSWORD(HttpStatus.BAD_REQUEST, "400032", "not changed when compare with old password"),
    _400_IN_USAGE_EMAIL(HttpStatus.BAD_REQUEST, "400033", "already used by another member"),
    _400_NO_SUCH_IMAGE(HttpStatus.BAD_REQUEST, "400034", "can not find such image"),
    ...
    _403_MAIL_ALREADY_AUTHENTICATED(HttpStatus.FORBIDDEN, "403003", "this member's email is already authenticated"),
    ...
    _409_DATA_INTEGRITY_VIOLATION(HttpStatus.CONFLICT, "409003", "data integrity violation"),
    ...
    _500_PUT_S3_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "500004", "put file to S3 fail"),
